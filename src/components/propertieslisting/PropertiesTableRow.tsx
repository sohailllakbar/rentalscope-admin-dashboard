      ...
      <td className="border border-[#4747474D] px-6 py-6 text-center">
        <div className="flex items-center justify-center gap-3">
          <button
            onClick={handleView}
            disabled={isViewing}
            className="rounded-[5px] bg-linear-to-b from-[#0D80E1] to-[#085799] px-8 py-2.5 text-[17px] font-medium text-white transition-all duration-200 ease-out hover:shadow-[0_4px_12px_rgba(13,128,225,0.3)] hover:brightness-110 active:scale-[0.98] disabled:cursor-wait disabled:opacity-80 md:text-[18px]"
          >
